...
if ($search) {
    ...
    $stmtRetrieval->bindValue(':employee_id', $_SESSION['employee_id']);
} else {
    $stmtRetrieval->bindValue(':employee_id', $_SESSION['employee_id']);
}
...
<body class="font-medium">
                    ...
                    <div class="employee-main-content">
                        <div class="employee-header">
                            <div class="employee-header-div">
                                <form method="GET" action="view_payroll.php">
                                    ...
                                    <div>
                                        <?php if (isset($_GET['search']) && !empty($_GET['search'])): ?>
                                            <a href="view_payroll.php" class="clear-search">Clear Search</a>
                                        <?php endif; ?>
                                    </div>
                                </form>
                            </div>
    ...
    <dialog id="payroll_details">
        <form action="view_payroll.php" method="POST" class="flex flex-column gap-20">
            <div>
    ...
    <dialog id="add_payroll_modal" style="border-radius: 10px; border: 1px solid #D1D1D1;">
        <form action="view_payroll.php" method="POST" class="flex flex-column">
            <div>
                <div id="modal_close_btn" style="position: absolute; top: 10px; right: 10px; cursor: pointer;"
