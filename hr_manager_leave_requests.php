...
if (isset($_GET['search']) && !empty($_GET['search'])) {
    ...
    try {
        $sql_search = "SELECT
                        ...
                        WHERE
                            (
                                (lr.hr_manager_approval = 'Pending' AND lr.tl_approval = 'Approved') 
                    ...
                    <div class="employee-main-content">
                        <div class="employee-header">
                            <div class="employee-header-div">
                                <form method="GET" action="hr_manager_leave_requests.php">
                                    ...
                                    <div> <?php if (isset($_GET['search']) && !empty($_GET['search'])): ?>
                                            <a href="hr_manager_leave_requests.php" class="clear-search">Clear Search</a>
                                        <?php endif; ?>
                                    </div>
                                </form>
                            </div>
