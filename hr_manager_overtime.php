                    ...
                    <div class="employee-main-content">
                        <div class="employee-header">
                            <div class="employee-header-div">
                                <form method="GET" action="hr_manager_overtime.php"
                                    ...
                                    <?php if (!empty($searchQuery)): ?>
                                        <a href="hr_manager_overtime.php" class="clear-search"
                                            style="text-decoration: underline; font-size: 14px;">Clear Search</a>
                                    <?php endif; ?>
                                </form>
                            </div>
                        </div>
