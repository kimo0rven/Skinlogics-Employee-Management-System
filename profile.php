                                ...
                                <div class="tab-panels">
                                    ...
                                    <section id="personal_information" class="tab-panel">
                                        ...
                                        <div class="flex flex-rowflex-start space-between flex-wrap">
                                            <div class="profile-detail-fields"><p>Full Name: <?php echo $currentUser['first_name'] . " " . $currentUser['middle_name'] . " " . $currentUser['last_name']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Mobile: <?php echo $currentUser['mobile']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Email: <?php echo $currentUser['email']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Gender: <?php echo $currentUser['gender']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Date of Birth: <?php echo $currentUser['dob']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Civil Status: <?php echo $currentUser['civil_status']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Street: <?php echo $currentUser['street']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Barangay: <?php echo $currentUser['barangay']; ?></p></div>
                                            <div class="profile-detail-fields"><p>City: <?php echo $currentUser['city']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Province: <?php echo $currentUser['province']; ?></p></div>
                                        </div>
                                    </section>
                                    ...
                                    <section id="contact_information" class="tab-panel">
                                        ...
                                        <div class="flex flex-rowflex-start space-between flex-wrap">
                                            <div class="profile-detail-fields">
                                                <p>Contact Person: <?php echo $currentUser['emergency_contact_name']; ?></p>
                                            </div>
                                            <div class="profile-detail-fields">
                                                <p>Contact Number: <?php echo $currentUser['emergency_contact_number']; ?></p>
                                            </div>
                                            <div class="profile-detail-fields">
                                                <p>Contact Relationship: <?php echo $currentUser['emergency_contact_relationship']; ?></p>
                                            </div>
                                        </div>
                                    </section>
                                    ...
                                    <section id="government_agencies" class="tab-panel">
                                        ...
                                        <div class="flex flex-rowflex-start space-between flex-wrap">
                                            <div class="profile-detail-fields"><p>SSS Number: <?php echo $currentUser['sss_number']; ?></p></div>
                                            <div class="profile-detail-fields"><p>Pag-IBIG Number: <?php echo $currentUser['pagibig_number']; ?></p></div>
                                            <div class="profile-detail-fields"><p>PhilHealth Number: <?php echo $currentUser['philhealth_number']; ?></p></div>
                                            <div class="profile-detail-fields"><p>TIN: <?php echo $currentUser['tin_number']; ?></p></div>
                                        </div>
                                    </section>
